...
class HXCPP_CLASS_ATTRIBUTES HealthIcon_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(::String __o__hx_char, ::Dynamic __o_isPlayer);
		...
		static ::hx::ObjectPtr< HealthIcon_obj > __new(::String __o__hx_char, ::Dynamic __o_isPlayer);
		static ::hx::ObjectPtr< HealthIcon_obj > __alloc(::hx::Ctx *_hx_ctx,::String __o__hx_char, ::Dynamic __o_isPlayer);
