...
#endif
#ifndef INCLUDED___ASSET__OPENFL__assets_fonts_riffic_ttf
#include <__ASSET__OPENFL__assets_fonts_riffic_ttf.h>
#endif
...
HXLINE(  53)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_aller_rg_ttf >());
HXLINE(  54)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_vcr_ttf >());
HXLINE(  55)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_riffic_ttf >());
HXLINE(  56)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_ubuntu_b_ttf >());
HXLINE(  57)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_lanapixel_ttf >());
HXLINE(  58)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf >());
HXLINE(  59)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_monsterrat_ttf >());
HXLINE(  63)		 ::Dynamic data;
HXDLIN(  63)		 ::Dynamic manifest;
HXDLIN(  63)		 ::Dynamic bundle;
HXLINE(  76)		{
HXLINE(  76)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/songs.json",38,27,75,ee));
HXDLIN(  76)			::lime::utils::Assets_obj::libraryPaths->set(HX_("songs",fe,36,c7,80),v);
            		}
HXLINE(  77)		{
HXLINE(  77)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/shared.json",f1,c2,0a,f4));
HXDLIN(  77)			::lime::utils::Assets_obj::libraryPaths->set(HX_("shared",a5,5e,2b,1d),v1);
            		}
HXLINE(  78)		{
HXLINE(  78)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/week6.json",f4,c1,fb,f1));
HXDLIN(  78)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week6",c2,95,be,c7),v2);
            		}
HXLINE(  79)		{
HXLINE(  79)			::String v3 = (::ManifestResources_obj::rootPath + HX_("manifest/monika.json",e3,8b,c8,aa));
HXDLIN(  79)			::lime::utils::Assets_obj::libraryPaths->set(HX_("monika",f3,3a,66,c7),v3);
            		}
HXLINE(  80)		{
HXLINE(  80)			::String v4 = (::ManifestResources_obj::rootPath + HX_("manifest/doki.json",2d,05,3e,c9));
HXDLIN(  80)			::lime::utils::Assets_obj::libraryPaths->set(HX_("doki",e9,ed,6d,42),v4);
            		}
HXLINE(  81)		{
HXLINE(  81)			::String v5 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  81)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v5);
            		}
HXLINE(  63)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
...
HXLINE(  90)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week6",c2,95,be,c7));
HXLINE(  91)		if (::hx::IsNotNull( library )) {
HXLINE(  91)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  92)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week6",c2,95,be,c7));
            		}
HXLINE(  93)		library = ::lime::utils::Assets_obj::getLibrary(HX_("monika",f3,3a,66,c7));
HXLINE(  94)		if (::hx::IsNotNull( library )) {
HXLINE(  94)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  95)			::ManifestResources_obj::preloadLibraryNames->push(HX_("monika",f3,3a,66,c7));
            		}
HXLINE(  96)		library = ::lime::utils::Assets_obj::getLibrary(HX_("doki",e9,ed,6d,42));
HXLINE(  97)		if (::hx::IsNotNull( library )) {
HXLINE(  97)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  98)			::ManifestResources_obj::preloadLibraryNames->push(HX_("doki",e9,ed,6d,42));
            		}
HXLINE(  99)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE( 100)		if (::hx::IsNotNull( library )) {
HXLINE( 100)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 101)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
