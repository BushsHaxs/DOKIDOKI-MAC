...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("DokiTakeover", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("DokiTakeover", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "DDTO Team";
		app.meta["file"] = "DokiTakeover";
		app.meta["name"] = "Friday Night Funkin': Doki Doki Takeover!";
		app.meta["packageName"] = "com.ddtoteam.dokitakeover";
		app.meta["version"] = "2.0.3";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Doki Doki Takeover!",
			width: 1280,
			x: null,
			y: null,
		};
