...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_55_init,"Main","init",0xea732345,"Main.init","Main.hx",55,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_65_setupGame,"Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",65,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_116_toggleFPS,"Main","toggleFPS",0x9eefd060,"Main.toggleFPS","Main.hx",116,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_121_changeFPSColor,"Main","changeFPSColor",0xbde8c2bf,"Main.changeFPSColor","Main.hx",121,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_126_setFPSCap,"Main","setFPSCap",0x4fb5c496,"Main.setFPSCap","Main.hx",126,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_131_getFPSCap,"Main","getFPSCap",0x6c64d88a,"Main.getFPSCap","Main.hx",131,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_136_getFPS,"Main","getFPS",0xd3c70468,"Main.getFPS","Main.hx",136,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_37_main,"Main","main",0xed0e206e,"Main.main","Main.hx",37,0x087e5c05)
...
HXLINE(  21)		this->initialState = ::hx::ClassOf< ::Caching >();
HXLINE(  19)		this->gameHeight = 720;
HXLINE(  18)		this->gameWidth = 1280;
HXLINE(  42)		super::__construct();
HXLINE(  44)		if (::hx::IsNotNull( this->stage )) {
HXLINE(  46)			this->init(null());
            		}
            		else {
HXLINE(  50)			this->addEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null(),null(),null());
            		}
            	}
...
void Main_obj::init( ::openfl::events::Event E){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_55_init)
HXLINE(  56)		if (this->hasEventListener(HX_("addedToStage",63,22,55,0c))) {
HXLINE(  58)			this->removeEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null());
            		}
HXLINE(  61)		this->setupGame();
            	}
...
void Main_obj::setupGame(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_65_setupGame)
HXLINE(  66)		int stageWidth = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXLINE(  67)		int stageHeight = ::openfl::Lib_obj::get_current()->stage->stageHeight;
HXLINE(  69)		if ((this->zoom == -1)) {
HXLINE(  71)			Float ratioX = (( (Float)(stageWidth) ) / ( (Float)(this->gameWidth) ));
HXLINE(  72)			Float ratioY = (( (Float)(stageHeight) ) / ( (Float)(this->gameHeight) ));
HXLINE(  73)			this->zoom = ::Math_obj::min(ratioX,ratioY);
HXLINE(  74)			this->gameWidth = ::Math_obj::ceil((( (Float)(stageWidth) ) / this->zoom));
HXLINE(  75)			this->gameHeight = ::Math_obj::ceil((( (Float)(stageHeight) ) / this->zoom));
            		}
...
HXLINE( 105)		this->fpsCounter =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE( 106)		this->addChild(this->fpsCounter);
HXLINE( 107)		this->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
            	}
...
void Main_obj::toggleFPS(bool fpsEnabled){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_116_toggleFPS)
HXDLIN( 116)		this->fpsCounter->set_visible(fpsEnabled);
            	}
...
void Main_obj::changeFPSColor(int color){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_121_changeFPSColor)
HXDLIN( 121)		this->fpsCounter->set_textColor(color);
            	}
...
void Main_obj::setFPSCap(Float cap){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_126_setFPSCap)
HXDLIN( 126)		::openfl::Lib_obj::get_current()->stage->set_frameRate(cap);
            	}
...
Float Main_obj::getFPSCap(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_131_getFPSCap)
HXDLIN( 131)		return ::openfl::Lib_obj::get_current()->stage->get_frameRate();
            	}
...
Float Main_obj::getFPS(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_136_getFPS)
HXDLIN( 136)		return ( (Float)(this->fpsCounter->currentFPS) );
            	}
...
void Main_obj::main(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_37_main)
HXDLIN(  37)		 ::openfl::display::MovieClip _hx_tmp = ::openfl::Lib_obj::get_current();
HXDLIN(  37)		_hx_tmp->addChild( ::Main_obj::__alloc( HX_CTX ));
            	}
