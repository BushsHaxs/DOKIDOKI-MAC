...
HX_DEFINE_STACK_FRAME(_hx_pos_fbbdc6bb86a8b7a6_12_new,"OptionCategory","new",0x84c54225,"OptionCategory.new","Options.hx",12,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fbbdc6bb86a8b7a6_18_getOptions,"OptionCategory","getOptions",0xd3403a43,"OptionCategory.getOptions","Options.hx",18,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fbbdc6bb86a8b7a6_23_addOption,"OptionCategory","addOption",0xcc3f9bfb,"OptionCategory.addOption","Options.hx",23,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fbbdc6bb86a8b7a6_28_removeOption,"OptionCategory","removeOption",0x584f1c74,"OptionCategory.removeOption","Options.hx",28,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fbbdc6bb86a8b7a6_35_getName,"OptionCategory","getName",0xe1f05a46,"OptionCategory.getName","Options.hx",35,0x9d9a0240)

void OptionCategory_obj::__construct(::String catName,::Array< ::Dynamic> options){
            	HX_STACKFRAME(&_hx_pos_fbbdc6bb86a8b7a6_12_new)
HXLINE(  31)		this->_name = HX_("New Category",fe,76,fc,27);
HXLINE(  14)		this->_options = ::Array_obj< ::Dynamic>::__new();
HXLINE(  40)		this->_name = catName;
HXLINE(  41)		this->_options = options;
            	}
...
::Array< ::Dynamic> OptionCategory_obj::getOptions(){
            	HX_STACKFRAME(&_hx_pos_fbbdc6bb86a8b7a6_18_getOptions)
HXDLIN(  18)		return this->_options;
            	}
...
void OptionCategory_obj::addOption( ::Option opt){
            	HX_STACKFRAME(&_hx_pos_fbbdc6bb86a8b7a6_23_addOption)
HXDLIN(  23)		this->_options->push(opt);
            	}
...
void OptionCategory_obj::removeOption( ::Option opt){
            	HX_STACKFRAME(&_hx_pos_fbbdc6bb86a8b7a6_28_removeOption)
HXDLIN(  28)		this->_options->remove(opt);
            	}
...
::String OptionCategory_obj::getName(){
            	HX_STACKFRAME(&_hx_pos_fbbdc6bb86a8b7a6_35_getName)
HXDLIN(  35)		return this->_name;
            	}
