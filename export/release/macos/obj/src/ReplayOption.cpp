...
HX_DEFINE_STACK_FRAME(_hx_pos_1637001de69262c2_502_new,"ReplayOption","new",0x7094b10e,"ReplayOption.new","Options.hx",502,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_508_press,"ReplayOption","press",0x73453bb1,"ReplayOption.press","Options.hx",508,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_516_updateDisplay,"ReplayOption","updateDisplay",0xfbfe5567,"ReplayOption.updateDisplay","Options.hx",516,0x9d9a0240)

void ReplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_502_new)
HXLINE( 503)		super::__construct();
HXLINE( 504)		this->description = desc;
            	}
...
bool ReplayOption_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_1637001de69262c2_508_press)
HXLINE( 509)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),509,HX_("ReplayOption",1c,d2,4f,b9),HX_("press",83,53,88,c8)));
HXLINE( 510)		{
HXLINE( 510)			 ::flixel::FlxState nextState =  ::LoadReplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 510)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 510)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
...
::String ReplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_516_updateDisplay)
HXDLIN( 516)		return ::LangUtil_obj::getString(HX_("optReplay",ba,9f,8e,8f));
            	}
