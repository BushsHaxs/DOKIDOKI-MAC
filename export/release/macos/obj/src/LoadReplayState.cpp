...
HX_DEFINE_STACK_FRAME(_hx_pos_67c80871309dda48_18_new,"LoadReplayState","new",0x1e338fb6,"LoadReplayState.new","LoadReplayState.hx",18,0xb45e587a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_97_getWeekNumbFromSong,"LoadReplayState","getWeekNumbFromSong",0x140b87fb,"LoadReplayState.getWeekNumbFromSong","LoadReplayState.hx",97,0xb45e587a)
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_110_addSong,"LoadReplayState","addSong",0x8f3688ec,"LoadReplayState.addSong","LoadReplayState.hx",110,0xb45e587a)
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_114_addWeek,"LoadReplayState","addWeek",0x91d3c50b,"LoadReplayState.addWeek","LoadReplayState.hx",114,0xb45e587a)
static const ::String _hx_array_data_8a203cc4_21[] = {
	HX_("bf",c4,55,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_129_update,"LoadReplayState","update",0x971f8073,"LoadReplayState.update","LoadReplayState.hx",129,0xb45e587a)
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_159_changeSelection,"LoadReplayState","changeSelection",0x45620112,"LoadReplayState.changeSelection","LoadReplayState.hx",159,0xb45e587a)
...
void LoadReplayState_obj::__construct( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut){
            	HX_STACKFRAME(&_hx_pos_67c80871309dda48_18_new)
HXLINE( 156)		this->isSettingControl = false;
HXLINE(  26)		this->actualNames = ::Array_obj< ::String >::__new(0);
...
HXDLIN(  34)		::String menuBG1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  34)		 ::flixel::FlxSprite menuBG2 = menuBG->loadGraphic(menuBG1,null(),null(),null(),null(),null());
HXLINE(  35)		this->controlsStrings = ::sys::FileSystem_obj::readDirectory((::Sys_obj::getCwd() + HX_("/assets/replays/",40,86,c0,57)));
HXLINE(  36)		::haxe::Log_obj::trace(this->controlsStrings,::hx::SourceInfo(HX_("source/LoadReplayState.hx",6e,34,7a,fb),36,HX_("LoadReplayState",c4,3c,20,8a),HX_("create",fc,66,0f,7c)));
HXLINE(  38)		this->controlsStrings->sort(::Reflect_obj::compare_dyn());
HXLINE(  40)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_4,3),1,::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_5,1));
HXLINE(  41)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_6,3),2,::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_7,1));
HXLINE(  42)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_8,3),3,::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_9,1));
HXLINE(  44)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_10,3),4,::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_11,1));
HXLINE(  45)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_12,3),5,::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_13,3));
HXLINE(  47)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_14,3),6,::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_15,3));
HXLINE(  49)		{
HXLINE(  49)			int _g = 0;
HXDLIN(  49)			int _g1 = this->controlsStrings->length;
HXDLIN(  49)			while((_g < _g1)){
HXLINE(  49)				_g = (_g + 1);
HXDLIN(  49)				int i = (_g - 1);
HXLINE(  51)				::String string = this->controlsStrings->__get(i);
HXLINE(  52)				this->actualNames[i] = string;
HXLINE(  53)				 ::Replay rep = ::Replay_obj::LoadReplay(string);
HXLINE(  54)				::Array< ::String > _hx_tmp = this->controlsStrings;
HXDLIN(  54)				::String _hx_tmp1 = (string.split(HX_("time",0d,cc,fc,4c))->__get(0) + HX_(" ",20,00,00,00));
HXDLIN(  54)				::String _hx_tmp2;
HXDLIN(  54)				if (::hx::IsEq( rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic),2 )) {
HXLINE(  54)					_hx_tmp2 = HX_("HARD",eb,f6,c8,2f);
            				}
            				else {
HXLINE(  54)					if (::hx::IsEq( rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic),1 )) {
HXLINE(  54)						_hx_tmp2 = HX_("EASY",02,54,cd,2d);
            					}
            					else {
HXLINE(  54)						_hx_tmp2 = HX_("NORMAL",27,1e,ec,e2);
            					}
            				}
HXDLIN(  54)				_hx_tmp[i] = (_hx_tmp1 + _hx_tmp2);
            			}
            		}
HXLINE(  57)		if ((this->controlsStrings->length == 0)) {
HXLINE(  58)			this->controlsStrings->push(HX_("No Replays...",81,d1,ed,00));
            		}
HXLINE(  60)		menuBG2->set_color(-1412611);
HXLINE(  61)		menuBG2->setGraphicSize(::Std_obj::_hx_int((menuBG2->get_width() * ((Float)1.1))),null());
HXLINE(  62)		menuBG2->updateHitbox();
HXLINE(  63)		menuBG2->screenCenter(null());
HXLINE(  64)		menuBG2->set_antialiasing(true);
HXLINE(  65)		this->add(menuBG2);
HXLINE(  67)		this->grpControls =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE(  68)		this->add(this->grpControls);
HXLINE(  70)		{
HXLINE(  70)			int _g2 = 0;
HXDLIN(  70)			int _g3 = this->controlsStrings->length;
HXDLIN(  70)			while((_g2 < _g3)){
HXLINE(  70)				_g2 = (_g2 + 1);
HXDLIN(  70)				int i = (_g2 - 1);
HXLINE(  72)				 ::Alphabet controlLabel =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->controlsStrings->__get(i),true,false);
HXLINE(  73)				controlLabel->isMenuItem = true;
HXLINE(  74)				controlLabel->targetY = ( (Float)(i) );
HXLINE(  75)				this->grpControls->add(controlLabel).StaticCast<  ::Alphabet >();
            			}
            		}
HXLINE(  79)		this->versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,(::flixel::FlxG_obj::height - 34),0,HX_("Replay Loader (ESCAPE TO GO BACK)\nNOTICE!!!! Replays are in a beta stage, and they are probably not 100% correct. expect misses and other stuff that isn't there!",b8,5a,29,fe),12,null());
HXLINE(  82)		this->versionShit->scrollFactor->set(null(),null());
HXLINE(  83)		 ::flixel::text::FlxText _hx_tmp = this->versionShit;
HXDLIN(  83)		_hx_tmp->setFormat(::LangUtil_obj::getFont(null()),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  84)		this->add(this->versionShit);
HXLINE(  86)		this->poggerDetails =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,34,0,HX_("Replay Details - \nnone",38,c3,7c,19),12,null());
HXLINE(  87)		this->poggerDetails->scrollFactor->set(null(),null());
HXLINE(  88)		 ::flixel::text::FlxText _hx_tmp1 = this->poggerDetails;
HXDLIN(  88)		_hx_tmp1->setFormat(::LangUtil_obj::getFont(null()),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  89)		this->add(this->poggerDetails);
HXLINE(  91)		this->changeSelection(0);
HXLINE(  93)		this->super::create();
            	}


int LoadReplayState_obj::getWeekNumbFromSong(::String songName){
            	HX_STACKFRAME(&_hx_pos_67c80871309dda48_97_getWeekNumbFromSong)
HXLINE(  98)		int week = 0;
HXLINE(  99)		{
HXLINE(  99)			int _g = 0;
HXDLIN(  99)			int _g1 = this->songs->length;
HXDLIN(  99)			while((_g < _g1)){
HXLINE(  99)				_g = (_g + 1);
HXDLIN(  99)				int i = (_g - 1);
HXLINE( 101)				 ::SongMetadata pog = this->songs->__get(i).StaticCast<  ::SongMetadata >();
HXLINE( 102)				if ((pog->songName.toLowerCase() == songName)) {
HXLINE( 103)					week = pog->week;
            				}
            			}
            		}
HXLINE( 105)		return week;
            	}
...
void LoadReplayState_obj::addSong(::String songName,int weekNum,::String songCharacter){
            	HX_GC_STACKFRAME(&_hx_pos_67c80871309dda48_110_addSong)
HXDLIN( 110)		::Array< ::Dynamic> _hx_tmp = this->songs;
HXDLIN( 110)		_hx_tmp->push( ::SongMetadata_obj::__alloc( HX_CTX ,songName,weekNum,songCharacter));
            	}
...
void LoadReplayState_obj::addWeek(::Array< ::String > songs,int weekNum,::Array< ::String > songCharacters){
            	HX_STACKFRAME(&_hx_pos_67c80871309dda48_114_addWeek)
HXLINE( 115)		if (::hx::IsNull( songCharacters )) {
HXLINE( 116)			songCharacters = ::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_21,1);
            		}
HXLINE( 118)		int num = 0;
HXLINE( 119)		{
HXLINE( 119)			int _g = 0;
HXDLIN( 119)			while((_g < songs->length)){
HXLINE( 119)				::String song = songs->__get(_g);
HXDLIN( 119)				_g = (_g + 1);
HXLINE( 121)				this->addSong(song,weekNum,songCharacters->__get(num));
HXLINE( 123)				if ((songCharacters->length != 1)) {
HXLINE( 124)					num = (num + 1);
            				}
            			}
            		}
            	}
...
void LoadReplayState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_67c80871309dda48_129_update)
HXLINE( 130)		this->super::update(elapsed);
HXLINE( 132)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 133)			 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 133)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 133)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
HXLINE( 134)		if (::PlayerSettings_obj::player1->controls->_upP->check()) {
HXLINE( 135)			this->changeSelection(-1);
            		}
HXLINE( 136)		if (::PlayerSettings_obj::player1->controls->_downP->check()) {
HXLINE( 137)			this->changeSelection(1);
            		}
HXLINE( 139)		bool _hx_tmp;
HXDLIN( 139)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 139)			_hx_tmp = (Dynamic( this->grpControls->members->__get(this->curSelected)).StaticCast<  ::Alphabet >()->text != HX_("No Replays...",81,d1,ed,00));
            		}
            		else {
HXLINE( 139)			_hx_tmp = false;
            		}
HXDLIN( 139)		if (_hx_tmp) {
HXLINE( 141)			::haxe::Log_obj::trace((HX_("loading ",24,de,81,cb) + this->actualNames->__get(this->curSelected)),::hx::SourceInfo(HX_("source/LoadReplayState.hx",6e,34,7a,fb),141,HX_("LoadReplayState",c4,3c,20,8a),HX_("update",09,86,05,87)));
HXLINE( 142)			::PlayState_obj::rep = ::Replay_obj::LoadReplay(this->actualNames->__get(this->curSelected));
HXLINE( 144)			::PlayState_obj::loadRep = true;
HXLINE( 146)			::String poop = ( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ).toLowerCase();
HXDLIN( 146)			::String poop1 = ::Highscore_obj::formatSong(poop,( (int)(::PlayState_obj::rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic)) ));
HXLINE( 148)			::PlayState_obj::SONG = ::Song_obj::loadFromJson(poop1,( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ).toLowerCase());
HXLINE( 149)			::PlayState_obj::isStoryMode = false;
HXLINE( 150)			::PlayState_obj::storyDifficulty = ( (int)(::PlayState_obj::rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic)) );
HXLINE( 151)			::PlayState_obj::storyWeek = this->getWeekNumbFromSong(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ));
HXLINE( 152)			{
HXLINE( 152)				 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
void LoadReplayState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_67c80871309dda48_159_changeSelection)
HXLINE( 160)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 160)		_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 162)		 ::LoadReplayState _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 162)		_hx_tmp1->curSelected = (_hx_tmp1->curSelected + change);
HXLINE( 164)		if ((this->curSelected < 0)) {
HXLINE( 165)			this->curSelected = (this->grpControls->length - 1);
            		}
HXLINE( 166)		if ((this->curSelected >= this->grpControls->length)) {
HXLINE( 167)			this->curSelected = 0;
            		}
HXLINE( 169)		 ::Replay rep = ::Replay_obj::LoadReplay(this->actualNames->__get(this->curSelected));
HXLINE( 171)		 ::flixel::text::FlxText _hx_tmp2 = this->poggerDetails;
HXDLIN( 171)		::String _hx_tmp3 = ((HX_("Replay Details - \nDate Created: ",9c,0e,70,a7) + ::Std_obj::string( ::Dynamic(rep->replay->__Field(HX_("timestamp",d6,d4,ce,a5),::hx::paccDynamic)))) + HX_("\nSong: ",65,cd,f3,01));
HXLINE( 176)		::String _hx_tmp4;
HXDLIN( 176)		if (::hx::IsNotEq( rep->replay->__Field(HX_("replayGameVer",2a,ad,0b,ce),::hx::paccDynamic),::Replay_obj::version )) {
HXLINE( 176)			_hx_tmp4 = HX_("OUTDATED",28,3f,a2,5d);
            		}
            		else {
HXLINE( 176)			_hx_tmp4 = HX_("Latest",67,79,f7,89);
            		}
HXLINE( 171)		_hx_tmp2->set_text(( (::String)((((_hx_tmp3 + rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) + HX_("\nReplay Version: ",8f,f9,99,d3)) + _hx_tmp4)) ));
HXLINE( 180)		int bullShit = 0;
HXLINE( 182)		{
HXLINE( 182)			int _g = 0;
HXDLIN( 182)			::Array< ::Dynamic> _g1 = this->grpControls->members;
HXDLIN( 182)			while((_g < _g1->length)){
HXLINE( 182)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 182)				_g = (_g + 1);
HXLINE( 184)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 185)				bullShit = (bullShit + 1);
HXLINE( 187)				item->set_alpha(((Float)0.6));
HXLINE( 190)				if ((item->targetY == 0)) {
HXLINE( 192)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
            	}
