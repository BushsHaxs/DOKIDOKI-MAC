...
HX_LOCAL_STACK_FRAME(_hx_pos_9bd24c9adde08dff_37_recalculateTimings,"Conductor","recalculateTimings",0xbc148fdd,"Conductor.recalculateTimings","Conductor.hx",37,0xeb0fa157)
HX_LOCAL_STACK_FRAME(_hx_pos_9bd24c9adde08dff_44_mapBPMChanges,"Conductor","mapBPMChanges",0x401caab9,"Conductor.mapBPMChanges","Conductor.hx",44,0xeb0fa157)
HX_LOCAL_STACK_FRAME(_hx_pos_9bd24c9adde08dff_71_changeBPM,"Conductor","changeBPM",0xeafb6fe8,"Conductor.changeBPM","Conductor.hx",71,0xeb0fa157)
...
void Conductor_obj::recalculateTimings(){
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_37_recalculateTimings)
HXLINE(  38)		::Conductor_obj::safeFrames = ( (int)(::flixel::FlxG_obj::save->data->__Field(HX_("frames",a6,af,85,ac),::hx::paccDynamic)) );
HXLINE(  39)		::Conductor_obj::safeZoneOffset = ( (Float)(::Math_obj::floor(((( (Float)(::Conductor_obj::safeFrames) ) / ( (Float)(60) )) * ( (Float)(1000) )))) );
HXLINE(  40)		::Conductor_obj::timeScale = (::Conductor_obj::safeZoneOffset / ( (Float)(166) ));
            	}
...
void Conductor_obj::mapBPMChanges( ::Dynamic song){
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_44_mapBPMChanges)
HXLINE(  45)		::Conductor_obj::bpmChangeMap = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  47)		Float curBPM = ( (Float)(song->__Field(HX_("bpm",df,be,4a,00),::hx::paccDynamic)) );
HXLINE(  48)		int totalSteps = 0;
HXLINE(  49)		Float totalPos = ( (Float)(0) );
HXLINE(  50)		{
HXLINE(  50)			int _g = 0;
HXDLIN(  50)			int _g1 = ( (::Array< ::Dynamic>)(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic)) )->length;
HXDLIN(  50)			while((_g < _g1)){
HXLINE(  50)				_g = (_g + 1);
HXDLIN(  50)				int i = (_g - 1);
HXLINE(  52)				bool _hx_tmp;
HXDLIN(  52)				if (( (bool)( ::Dynamic(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("changeBPM",4f,4f,f8,1d),::hx::paccDynamic)) )) {
HXLINE(  52)					_hx_tmp = ::hx::IsNotEq(  ::Dynamic(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("bpm",df,be,4a,00),::hx::paccDynamic),curBPM );
            				}
            				else {
HXLINE(  52)					_hx_tmp = false;
            				}
HXDLIN(  52)				if (_hx_tmp) {
HXLINE(  54)					curBPM = ( (Float)( ::Dynamic(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("bpm",df,be,4a,00),::hx::paccDynamic)) );
HXLINE(  55)					 ::Dynamic event =  ::Dynamic(::hx::Anon_obj::Create(3)
...
HXLINE(  60)					::Conductor_obj::bpmChangeMap->push(event);
            				}
HXLINE(  63)				int deltaSteps = ( (int)( ::Dynamic(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("lengthInSteps",3c,ed,41,db),::hx::paccDynamic)) );
HXLINE(  64)				totalSteps = (totalSteps + deltaSteps);
HXLINE(  65)				totalPos = (totalPos + ((((( (Float)(60) ) / curBPM) * ( (Float)(1000) )) / ( (Float)(4) )) * ( (Float)(deltaSteps) )));
            			}
            		}
HXLINE(  67)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  67)		::String _hx_tmp1 = (HX_("new BPM map BUDDY ",ff,cc,e3,2e) + ::Std_obj::string(::Conductor_obj::bpmChangeMap));
HXDLIN(  67)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/Conductor.hx",4b,4e,2d,f0),67,HX_("Conductor",c7,77,a1,7b),HX_("mapBPMChanges",a0,c9,ba,4a)));
            	}
...
void Conductor_obj::changeBPM(Float newBpm){
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_71_changeBPM)
HXLINE(  72)		::Conductor_obj::bpm = newBpm;
HXLINE(  74)		::Conductor_obj::crochet = ((( (Float)(60) ) / ::Conductor_obj::bpm) * ( (Float)(1000) ));
HXLINE(  75)		::Conductor_obj::stepCrochet = (::Conductor_obj::crochet / ( (Float)(4) ));
            	}
...
HXDLIN(  27)		safeZoneOffset = ( (Float)(::Math_obj::floor(((( (Float)(::Conductor_obj::safeFrames) ) / ( (Float)(60) )) * ( (Float)(1000) )))) );
            	}
{
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_28_boot)
HXDLIN(  28)		timeScale = (::Conductor_obj::safeZoneOffset / ( (Float)(166) ));
            	}
{
