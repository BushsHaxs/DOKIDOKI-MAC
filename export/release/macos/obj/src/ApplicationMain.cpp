...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("DokiTakeover",44,00,fe,fa),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("DDTO Team",02,22,68,19));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("DokiTakeover",44,00,fe,fa));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': Doki Doki Takeover!",73,0e,a0,7d));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.ddtoteam.dokitakeover",2d,dd,d7,d6));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("2.0.3",39,66,95,e8));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': Doki Doki Takeover!",73,0e,a0,7d))
