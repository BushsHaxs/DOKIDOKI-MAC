...
class HXCPP_CLASS_ATTRIBUTES CoolUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static void __boot();
		static ::Array< ::String > programList;
		static ::String pfpPath;
		static bool grabbedPfp;
		static ::String difficultyString();
		static ::Dynamic difficultyString_dyn();

		static bool isRecording();
		static ::Dynamic isRecording_dyn();

		static ::String coolText(::String path);
		static ::Dynamic coolText_dyn();
