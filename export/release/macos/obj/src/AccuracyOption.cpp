...
HX_DEFINE_STACK_FRAME(_hx_pos_073f38f294c4fadc_166_new,"AccuracyOption","new",0x53bf62a0,"AccuracyOption.new","Options.hx",166,0x9d9a0240)
...
void AccuracyOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_166_new)
HXLINE( 167)		super::__construct();
HXLINE( 168)		this->description = desc;
            	}
...
HXDLIN( 180)		::String _hx_tmp = (::LangUtil_obj::getString(HX_("cmnAccuracy",dd,64,ea,32)) + HX_(" ",20,00,00,00));
...
HXDLIN( 180)			_hx_tmp1 = ::LangUtil_obj::getString(HX_("cmnOn",c3,6c,0b,49));
            		}
            		else {
HXDLIN( 180)			_hx_tmp1 = ::LangUtil_obj::getString(HX_("cmnOff",4b,b7,f3,a0));
            		}
HXDLIN( 180)		return (_hx_tmp + _hx_tmp1);
            	}
