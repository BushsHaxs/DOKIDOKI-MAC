...
HX_DEFINE_STACK_FRAME(_hx_pos_1cce971975218b09_45_new,"Option","new",0x702ed707,"Option.new","Options.hx",45,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_58_getDisplay,"Option","getDisplay",0x9ac5dc85,"Option.getDisplay","Options.hx",58,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_63_getAccept,"Option","getAccept",0x6ec11a25,"Option.getAccept","Options.hx",63,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_68_getDescription,"Option","getDescription",0xff3298bf,"Option.getDescription","Options.hx",68,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_74_press,"Option","press",0x2a2f91ea,"Option.press","Options.hx",74,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_79_updateDisplay,"Option","updateDisplay",0xbdef0ca0,"Option.updateDisplay","Options.hx",79,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_84_getValue,"Option","getValue",0xb1980af4,"Option.getValue","Options.hx",84,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_89_left,"Option","left",0xb77ad380,"Option.left","Options.hx",89,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1cce971975218b09_94_right,"Option","right",0x4b0b4a43,"Option.right","Options.hx",94,0x9d9a0240)

void Option_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_45_new)
HXLINE(  54)		this->acceptValues = false;
HXLINE(  52)		this->description = HX_("",00,00,00,00);
HXLINE(  49)		this->display = this->updateDisplay();
            	}
...
::String Option_obj::getDisplay(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_58_getDisplay)
HXDLIN(  58)		return this->display;
            	}
...
bool Option_obj::getAccept(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_63_getAccept)
HXDLIN(  63)		return this->acceptValues;
            	}
...
::String Option_obj::getDescription(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_68_getDescription)
HXDLIN(  68)		return this->description;
            	}
...
bool Option_obj::press(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_74_press)
HXDLIN(  74)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("stub!",33,93,1a,84)));
...
::String Option_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_79_updateDisplay)
HXDLIN(  79)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("stub!",33,93,1a,84)));
...
::String Option_obj::getValue(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_84_getValue)
HXDLIN(  84)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("stub!",33,93,1a,84)));
...
bool Option_obj::left(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_89_left)
HXDLIN(  89)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("stub!",33,93,1a,84)));
...
bool Option_obj::right(){
            	HX_STACKFRAME(&_hx_pos_1cce971975218b09_94_right)
HXDLIN(  94)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("stub!",33,93,1a,84)));
