...
HX_DEFINE_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_145_new,"GhostTapOption","new",0x6c686a7b,"GhostTapOption.new","Options.hx",145,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_151_press,"GhostTapOption","press",0xd68bea5e,"GhostTapOption.press","Options.hx",151,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_159_updateDisplay,"GhostTapOption","updateDisplay",0xb7c6f914,"GhostTapOption.updateDisplay","Options.hx",159,0x9d9a0240)

void GhostTapOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_145_new)
HXLINE( 146)		super::__construct();
HXLINE( 147)		this->description = desc;
            	}
...
bool GhostTapOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_151_press)
HXLINE( 152)		::flixel::FlxG_obj::save->data->__SetField(HX_("ghost",4f,8f,58,93),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghost",4f,8f,58,93),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 153)		this->display = this->updateDisplay();
HXLINE( 154)		return true;
            	}


::String GhostTapOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_159_updateDisplay)
HXDLIN( 159)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghost",4f,8f,58,93),::hx::paccDynamic)) )) {
HXDLIN( 159)			return ::LangUtil_obj::getString(HX_("optGhostTap",a7,01,bd,3d));
            		}
            		else {
HXDLIN( 159)			return ::LangUtil_obj::getString(HX_("optNoGhostTap",c8,81,b0,1b));
            		}
