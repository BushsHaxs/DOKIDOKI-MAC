...
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_309_getFired,"MultiCallback","getFired",0x1ac970a8,"MultiCallback.getFired","LoadingState.hx",309,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_312_getUnfired,"MultiCallback","getUnfired",0xfdf08a2f,"MultiCallback.getUnfired","LoadingState.hx",312,0x53ff9bc9)
...
::Array< ::String > MultiCallback_obj::getFired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_309_getFired)
HXDLIN( 309)		return this->fired->copy();
            	}
...
::Array< ::String > MultiCallback_obj::getUnfired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_312_getUnfired)
HXDLIN( 312)		::Array< ::String > _g = ::Array_obj< ::String >::__new(0);
HXDLIN( 312)		{
HXDLIN( 312)			 ::Dynamic id = this->unfired->keys();
HXDLIN( 312)			while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 312)				::String id1 = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXDLIN( 312)				_g->push(id1);
            			}
            		}
