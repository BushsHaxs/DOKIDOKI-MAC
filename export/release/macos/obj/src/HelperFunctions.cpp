...
HX_LOCAL_STACK_FRAME(_hx_pos_93698466c21ed147_4_truncateFloat,"HelperFunctions","truncateFloat",0x44fe3c15,"HelperFunctions.truncateFloat","HelperFunctions.hx",4,0xfb293df1)
...
Float HelperFunctions_obj::truncateFloat(Float number,int precision){
            	HX_STACKFRAME(&_hx_pos_93698466c21ed147_4_truncateFloat)
HXLINE(   5)		Float num = number;
HXLINE(   6)		num = (num * ::Math_obj::pow(( (Float)(10) ),( (Float)(precision) )));
HXLINE(   7)		num = (( (Float)(::Math_obj::round(num)) ) / ::Math_obj::pow(( (Float)(10) ),( (Float)(precision) )));
HXLINE(   8)		return num;
            	}
