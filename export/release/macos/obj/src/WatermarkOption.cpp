...
HXDLIN( 583)		::String _hx_tmp = (::LangUtil_obj::getString(HX_("optWatermark",f1,54,ff,86)) + HX_(" ",20,00,00,00));
HXDLIN( 583)		::String _hx_tmp1;
HXDLIN( 583)		if (::Main_obj::watermarks) {
HXDLIN( 583)			_hx_tmp1 = ::LangUtil_obj::getString(HX_("cmnOn",c3,6c,0b,49));
            		}
            		else {
HXDLIN( 583)			_hx_tmp1 = ::LangUtil_obj::getString(HX_("cmnOff",4b,b7,f3,a0));
            		}
HXDLIN( 583)		return (_hx_tmp + _hx_tmp1);
            	}
