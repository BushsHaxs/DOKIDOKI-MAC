...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String txt(::String key,::String library,::hx::Null< bool >  isLocale);
		...
		static ::Array< ::String > listAudioToCache(bool isSound);
		static ::Dynamic listAudioToCache_dyn();

		static bool doesSoundAssetExist(::String path);
		static ::Dynamic doesSoundAssetExist_dyn();

		static  ::flixel::graphics::FlxGraphic loadImage(::String key,::String library,::hx::Null< bool >  isLocale);
		static ::Dynamic loadImage_dyn();

		static ::String image(::String key,::String library,::hx::Null< bool >  isLocale);
		static ::Dynamic image_dyn();

		static ::String font(::String key);
		static ::Dynamic font_dyn();

		static  ::flixel::graphics::frames::FlxAtlasFrames getSparrowAtlas(::String key,::String library,::hx::Null< bool >  isLocale);
